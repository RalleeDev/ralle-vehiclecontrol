...
-- Indicator Feature
Config.Indicator = true -- Set to true if you want to use Indicators, Set to false if you dont want it.
Config.IndicatorKeys = {'F1', 'F3', 'F4'} -- The keys for triggering the indicators. They follow this template {LEFT_INDICATOR, RIGHT_INDICATOR, HAZARD_INDICATOR} https://docs.fivem.net/docs/game-references/input-mapper-parameter-ids/keyboard/
